...
function Body() {
  ...
  data.map((el, i) => {
    if (el.Position === "Goalkeeper") {
      ...
      nameOfGoalKeeper.push({ name: el.PlayerName,JerseyNumber:el.JerseyNumber, image: el.PlayerImage, Appearances: el.Appearances, MinutesPlayed: el.MinutesPlayed, CleanSheets: el.CleanSheets, Saves: el.Saves, Position: el.Position, Height: el.Height, Weight: el.Weight,Nationality:el.Nationality })
    }
    if (el.Position == "Defender") {
      numberOfdefenders.push(i);
      nameOfdefenders.push({name:el.PlayerName,JerseyNumber:el.JerseyNumber,image: el.PlayerImage, Appearances: el.Appearances, MinutesPlayed: el.MinutesPlayed, CleanSheets: el.CleanSheets, Saves: el.Saves, Position: el.Position, Height: el.Height, Weight: el.Weight,Nationality:el.Nationality})
    }
    if (el.Position == "Midfielder") {
      numberOfMidfielder.push(i);
      nameOfMidfielder.push({ name: el.PlayerName,JerseyNumber:el.JerseyNumber, image: el.PlayerImage, Appearances: el.Appearances, MinutesPlayed: el.MinutesPlayed, CleanSheets: el.CleanSheets, Saves: el.Saves, Position: el.Position, Height: el.Height, Weight: el.Weight,Nationality:el.Nationality })
    }
    if (el.Position == "Forward") {
      numberOfForward.push(i);
      nameOfForward.push({ name: el.PlayerName,JerseyNumber:el.JerseyNumber, image: el.PlayerImage, Appearances: el.Appearances, MinutesPlayed: el.MinutesPlayed, CleanSheets: el.CleanSheets, Saves: el.Saves, Position: el.Position, Height: el.Height, Weight: el.Weight,Nationality:el.Nationality })
    }


  });
  console.log("data", nameOfdefenders)
                  ...
                  <div className="playground2" style={{ background: `url(${playGround})` }}>
                    <div className="playerName" >
                      <div className="goalkeeper">
                        <p className="text">{nameOfGoalKeeper[0].JerseyNumber}</p>
                      </div>
                      <p>{nameOfGoalKeeper[0].name}</p>
                    </div>
                    <div className="position" >
                      <div className="circle">
                        <p className="text">{nameOfdefenders[0].JerseyNumber}</p>
                      </div>
                      
                      <p>{nameOfdefenders[0].name}</p>
                      <div className="circle">
                        <p className="text">{nameOfdefenders[1].JerseyNumber}</p>
                      </div>
                      <p>{nameOfdefenders[1].name}</p>
                      <div className="circle">
                        <p className="text">{nameOfdefenders[2].JerseyNumber}</p>
                      </div>
                      <p>{nameOfdefenders[2].name}</p>
                      <div className="circle">
                        <p className="text">{nameOfdefenders[3].JerseyNumber}</p>
                      </div>
                      <p>{nameOfdefenders[3].name}</p>
                    </div>
                    <div className="position" >
                      <div className="circle">
                        <p className="text">{nameOfMidfielder[0].JerseyNumber}</p>
                      </div>
                      <p>{nameOfMidfielder[0].name}</p>
                      <div className="circle">
                        <p className="text">{nameOfMidfielder[1].JerseyNumber}</p>
                      </div>
                      <p>{nameOfMidfielder[1].name}</p>
                      <div className="circle">
                        <p className="text">{nameOfMidfielder[2].JerseyNumber}</p>
                      </div>
                      <p>{nameOfMidfielder[2].name}</p>
                      <div className="circle">
                        <p className="text">{nameOfMidfielder[3].JerseyNumber}</p>
                      </div>
                      <p>{nameOfMidfielder[3].name}</p>
                    </div>
                    <div className="position" style={{ width: "150px", marginTop: "100px" }}>
                      <div className="circle">
                        <p className="text">{nameOfForward[0].JerseyNumber}</p>
                      </div>
                      <p>{nameOfForward[0].name}</p>
                      <div className="circle">
                        <p className="text">{nameOfForward[1].JerseyNumber}</p>
                      </div>
                      <p>{nameOfForward[1].name}</p>
                      <div className="circle">
                        <p className="text">{nameOfForward[2].JerseyNumber}</p>
                      </div>
                      <p>{nameOfForward[2].name}</p>

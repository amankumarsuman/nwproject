  ...
  produce(state, (draftState) => {
    ...
    switch (type) {
      ...
      case FORM_TYPES.UPDATE_FORM_DATA: {
        ...
        draftState.mainTable.data.map((el,i)=>{
         if(el.JerseyNumber==payload.JerseyNumber){
           console.log(i,"index")
          // draftState.mainTable.data[i]={
          //   ...draftState.mainTable.data=payload
            
          // }
         }
        })
        // draftState.mainTable.data[payload.JerseyNumber]=draftState.mainTable.data[payload.JerseyNumber]
        break;
      }
      ...
      case FORM_TYPES.DELETE_TABLE_DATA: {
        ...
        draftState.mainTable.data = draftState.mainTable.data.filter(item => item.JerseyNumber !== deleteItem);
